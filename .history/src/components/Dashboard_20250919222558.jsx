...
const Dashboard = () => {
  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border p-4 sm:p-6 border-gray-300">
      ...
      <div className="bg-white w-60 h-64 flex flex-col justify-start p-10 rounded-lg border border-gray-300 shadow-md ">
        <label htmlFor="font-bold text-xl">Today's Operation</label>
        <label htmlFor="">Appointments:7</label>
        <label htmlFor="">Surgeries:2</label>
        <label htmlFor="">Dental Care:1</label>
        <label htmlFor="">Check up:4</label>
      </div>
    </div>
  );
};
