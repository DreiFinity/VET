  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border border-gray-300 p-4  sm:p-6">
      ...
      <div className="bg-[#f6f6f6] min-h-screen p-8 sm:p-6">
        ...
        <div className="flex  flex-col sm:flex-row gap-4 sm:gap-0  sm:justify-end">
          <button className="w-10 h-10 sm:flex-none flex-1 bg-gray-500 px-4 py-2 rounded-md text-white">
            {" "}
            Clear{" "}
          </button>
          <button className="w-10 h-19 sm:flex-none flex-1">
            {" "}
