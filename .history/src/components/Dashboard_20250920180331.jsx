    ...
    <div className="bg-white shadow-lg w-full max-w-[1300px] mx-auto rounded-xl overflow-hidden border p-4 sm:p-6 border-gray-300">
      ...
      >
        ...
        <div
          className={`transition-all duration-700 ${
            hasScrolled
              ? "w-1/3 flex flex-col space-y-4"
              : "flex flex-row space-x-5 mt-5 justify-center"
          }`}
        >
          {/* Card 1 */}
          <div
            className={`bg-white flex flex-col justify-start p-10 space-y-5 rounded-lg border border-gray-300 shadow-md transition-all duration-700 ${
              hasScrolled ? "h-full w-full" : "w-70 h-64"
            }`}
          >
            <label className="font-bold text-xl -mt-3">Today's Operation</label>
            <label className="text-md">Appointments:7</label>
            <label className="text-md">Surgeries:2</label>
            <label className="text-md">Dental Care:1</label>
            <label className="text-md">Check up:4</label>
          </div>
          ...
          >
            <label className="font-bold text-xl -mt-3">Weekly Statistics</label>
            <label className="text-md">New Patients:5</label>
            <label className="text-md">Transferee:3</label>
            <label className="text-md">Weekly Visitor:47</label>
          </div>
          ...
          >
            <label className="font-bold text-xl -mt-3">Staffs</label>
            <label className="text-lg">Total Staff:6</label>
          </div>
        </div>
      </div>
