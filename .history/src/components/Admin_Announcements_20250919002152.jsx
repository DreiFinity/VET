...
const Admin_Announcements = () => {
  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border border-gray-300 p-4 pb-10 sm:p-6">
      ...
      <div className="bg-[#f6f6f6] min-h-screen p-8 sm:p-6">
        ...
        <div className="flex flex-row mt-6 gap-6  border-b   pb-10">
