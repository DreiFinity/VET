...
const Dashboard = () => {
  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border p-4 sm:p-6 border-gray-300">
      ...
      <div className="bg-white w-32 h-64 flex flex-col justify-center items-center rounded-lg border border-gray-300 shadow-md ">
        <label htmlFor="font-bold items-center">Today's Operation</label>
      </div>
    </div>
  );
};
