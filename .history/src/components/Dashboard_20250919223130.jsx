...
const Dashboard = () => {
  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border p-4 sm:p-6 border-gray-300">
      ...
      <div className="bg-white w-70 h-55 flex flex-col justify-start p-10  space-y-5 rounded-lg border border-gray-300 shadow-md ">
        <label htmlFor="" className="font-bold text-xl mt-2">
          Today's Operation
        </label>
