      ...
      <div className="bg-white min-h-screen p-8 sm:p-6 mt-10">
        ...
        <div className="flex flex-row w-full justify-between">
          ...
          <div className=" flex flex-row space-x-5">
            <button className="bg-gray-500 px-4 py-2 text-sm w-30 h-10 rounded-full text-white">
              Edit
            </button>
            <button className="bg-red-500 px-4 py-2 w-30 h-10 text-sm rounded-full text-white">
              Delete
            </button>
          </div>
        </div>
