  ...
  return (
    <div className="bg-white shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border border-gray-300 p-4 sm:p-6">
      ...
      <div className="bg-[#f6f6f6] min-h-screen p-8 sm:p-6">
        ...
        {/* Target Audience Dropdown (with image icon) */}
        <div className="flex flex-row mt-6 relative w-64">
          <div className="flex flex-col">
            <label className="mb-1">Target Audience</label>
            <button
              type="button"
              onClick={() => setOpenAudience(!openAudience)}
              className="flex items-center justify-between w-lg px-3 py-2 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium"
            >
          ...
          <div className="flex flex-col ml-6 relative w-64">
            <label className="mb-1">Status</label>
            <button
              type="button"
              onClick={() => setOpenDraft(!openDraft)}
              className="flex items-center justify-between w-medium px-3 py-2 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium"
            >
