  ...
  return (
    <div className="bg-[#f6f6f6] shadow-lg w-full max-w-[1100px] mx-auto rounded-xl overflow-hidden border border-gray-300 p-4  sm:p-6">
      ...
      <div className="bg-white min-h-screen p-8 sm:p-6">
        ...
        <div className="flex flex-row mt-6 gap-6  border-b  border-gray-300 pb-10 mb-10">
      ...
      <div className="bg-white min-h-screen p-8 sm:p-6 mt-10">
        <div className="flex flex-row justify-between items-center mb-6 border-b border-gray-300 pb-8">
          <div>
        ...
        <div className="flex flex-row w-full justify-between">
          <div className="flex flex-col">
            ...
            <div className="flex flex-row space-x-4 mt-2 items-center">
              <label htmlFor="">Jan 15,2025- 10:30AM</label>
          ...
          <div className=" flex flex-row space-x-5">
            <button className="bg-gray-700 px-4 py-2 text-sm w-30 h-10 rounded-full text-white">
              Edit
            </button>
            <button className="bg-gray-700 px-4 py-2 w-30 h-10 text-sm rounded-full text-white">
              Delete
            </button>
          </div>
        </div>
