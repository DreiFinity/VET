...
const Dashboard = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setScrolled(window.scrollY > 150); // adjust trigger point
    };
    ...
    <div className="bg-white shadow-lg w-full max-w-[1300px] mx-auto rounded-xl overflow-hidden border p-4 sm:p-6 border-gray-300">
      ...
      <div
        className={`transition-all duration-500 ${
          scrolled
            ? "grid grid-cols-[2fr,1fr] gap-6 mt-10"
            : "flex flex-col mt-10"
        }`}
      >
        {/* Table Section */}
        ...
        >
          <div className="space-y-4">
            <div className="bg-white w-full h-48 flex flex-col justify-start p-6 space-y-3 rounded-lg border border-gray-300 shadow-md">
