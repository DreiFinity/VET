...
const Admin_BannedVet = () => {
  ...
  const users = [
    {
      Veterinary_Clinic: "Jo Capang Vetter",
      Vet_Id: "VC0000001",
      contact: "09123456789",
      email: "Jo_Capang_Vetter@gmail.com",
    },
    {
      Veterinary_Clinic: "Andrei",
      Vet_Id: "VC0000002",
      contact: "0946789446",
      email: "Jetter@gmail.com",
    },
    {
      Veterinary_Clinic: "Vetter",
      Vet_Id: "VC0000003",
      contact: "09112321321",
      email: "Jor@gmail.com",
    },
  ...
  // ✅ fix: define filteredUsers
  const filteredUsers = users.filter(
    (u) =>
      u.Veterinary_Clinic.toLowerCase().includes(search.toLowerCase()) ||
      u.Vet_Id.toLowerCase().includes(search.toLowerCase()) ||
        ...
        <table className="w-full min-w-[800px] border-collapse">
          ...
          <thead>
            <tr className="bg-[#989898] text-white text-left">
              <th className="px-4 py-2 font-regular">Veterinary Clinic</th>
              <th className="px-4 py-2 font-regular">Veterinary ID</th>
          ...
          <tbody>
            {filteredUsers.map((user, index) => (
              ...
              >
                <td className="px-4 py-2">{user.Veterinary_Clinic}</td>
                <td className="px-4 py-2">{user.Vet_Id}</td>
                ...
                <td className="px-4 py-2">
                  <button
                    onClick={() => alert(`Unbanned ${user.Veterinary_Clinic}`)}
