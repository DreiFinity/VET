...
import Admin_BannedUsers from "./components/Admin_BannedUsers";
import Admin_BannedVet from "./components/Admin_BannedVet";
import Admin_UserReports from "./components/Admin_UserReports";
import Billing from "./components/Admin_Billing";
import Admin_Announcements from "./components/Admin_Announcements";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin_bannedusers" element={<Admin_BannedUsers />} />
        <Route path="/admin_bannedvet" element={<Admin_BannedVet />} />
        <Route path="/admin_userreports" element={<Admin_UserReports />} />
        <Route path="/admin_billing" element={<Billing />} />
        <Route path="/admin_announcements" element={<Admin_Announcements />} />
