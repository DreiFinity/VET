...
const Admin_Announcements = () => {
  ...
  const handlePublish = async () => {
    ...
    if (!window.confirm("Are you sure you want to publish this announcement?"))
      return;
    const backendRole = roleMap[targetAudience];
  ...
  const handleEditOpen = (announcement) => {
    setEditData({
      ...announcement,
      targetAudience:
        roleBackendMap[announcement.targetAudience] || "All Users",
  ...
  const handleEditSave = async () => {
    ...
    try {
      const data = {
        ...
        targetAudience: roleBackendMap[editData.targetAudience],
